...
| 100 | BTC-BTC | BTC 网络 BTC 主链 Token |
| 200 | TON-TON | TON 网络 TON 主链 Token |
...
| 签名 | sign | 9e0ccfe3915e94bcc5bfbBsC5EUxV6 ... | 平台使用 RSA 对所有数据签名。 |

## 🔰 Token 基本信息

| 主链网络 | chain_id [主链 ID] | token_id [唯一 ID] | token_address [合约地址] | symbol[Token 缩写] | decimals[小数位] |
| --------------- | ------------------ | ------------------ | ---------------------------------------------------------------- | ----------------- | ---------------- |
