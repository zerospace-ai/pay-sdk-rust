...
| コイン名 | フルネーム | ブロックチェーンブラウザアドレス | Chain ID |
| :------------ | :------------------ | :------------------------------ | :----------- |
...
| TokenID | Value | 説明 |
| :------ | :------------ | :------------------------------- |
| 1 | ETH-ETH | ETH ネットワーク ETH |
| 2 | ETH-USDT | ETH ネットワーク USDT |
| 3 | TRON-TRX | TRON ネットワーク TRX |
| 4 | TRON-USDT | TRON ネットワーク Token: USDT |
| 5 | BNB-BNB | BNB Smart Chain ネットワーク BNB |
| 6 | BNB-USDT | BNB Smart Chain ネットワーク Token: USDT |
| 11 | Polygon-MATIC | Polygon ネットワーク Matic |
| 12 | Polygon-USDT | Polygon ネットワーク Token: USDT |
| 13 | Polygon-USDC | Polygon ネットワーク Token: USDC |
| 22 | BNB-USDC | BNB Smart Chain ネットワーク Token: USDC |
| 23 | BNB-DAI | BNB Smart Chain ネットワーク Token: DAI |
| 24 | ETH-USDC | ETH ネットワーク USDC |
| 25 | ETH-DAI | ETH ネットワーク DAI |
| 130 | Optimism-ETH | Optimism ネットワーク ETH |
| 131 | Optimism-WLD | Optimism ネットワーク Token: WLD |
| 132 | Optimism-USDT | Optimism ネットワーク Token: USDT |
| 100 | BTC-BTC | BTC ネットワーク BTC メイン chain トークン |
| 200 | TON-TON | TON ネットワーク TON メイン chain トークン |
...
| 署名 | sign | 9e0ccfe3915e94bcc5bfbBsC5EUxV6 ... | プラットフォームは RSA を使用してすべてのデータを署名します。 |

## 🔰 トークン基本情報

| メイン chain ネットワーク | chain_id [mainchain ID] | token_id [unique ID] | token_address [contract address] | symbol[Token abbreviation] | decimals[Decimal places] |
| --------------- | ------------------ | ------------------ | ---------------------------------------------------------------- | ----------------- | ---------------- |
